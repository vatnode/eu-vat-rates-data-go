...
// GetAllRates returns a copy of the full rates map (45 countries).
...
// HasRate returns true if the given country code is present in the dataset (all 45 countries).
